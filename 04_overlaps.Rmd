...
ggplot(data = OL1.df, aes(x=factor(Group.1), y = x, fill = Group.1)) + 
  ...
  labs(y = "counts", x = "genomic feature") +
...
p2.plot.pie = p2.plot + coord_polar("y", start=0) +
  ...
  #geom_text() +
  annotate("text", label = perc[1], size=5, x = 1.7, y = c(0.75)) +
  annotate("text", label = perc[2], size=5, x = 1.7, y = c(0.30)) +
  annotate("text", label = perc[3], size=5, x = 1.7, y = c(0.13)) +
  annotate("text", label = perc[4], size=5, x = 1.7, y = c(0.08)) +
  annotate("text", label = perc[5], size=5, x = 1.7, y = c(0.02)) 
