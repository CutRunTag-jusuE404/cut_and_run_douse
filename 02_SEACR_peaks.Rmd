...
```{r, plot_olap_ctrl}
plot(ctrl_olap.rate,type='b',ylab='# peaks', xlab='Overlap at least this many peaksets', main = "control samples (D3 + WTT)")
...
```{r, plot_olap_d3}
plot(d3_olap.rate, type='b',ylab='# peaks', xlab='Overlap at least this many peaksets', main = "D3 samples only")
